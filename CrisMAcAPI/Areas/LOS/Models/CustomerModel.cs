...
namespace CrisMAcAPI.Areas.LOS.Models
{
    public class CustomerModel
    {
        ...
        public string HomeMakerSourceOfIncome { get; set; }
        public string HomeMakerIncomeAmount { get; set; }
        ...
        public string ArticleCost { get; set; }
        ...
        public JObject InsertQECApplication()
        {
            ...
            try
            {
                using (command)
                {
                    ...
                    database.AddInParameter(command, "CoApplicantName", System.Data.DbType.String, CoApplicantName);
                    database.AddInParameter(command, "CoApplicantAge", System.Data.DbType.String, CoApplicantAge);
                    ...
                    database.AddInParameter(command, "HomeMakerSourceOfIncome", System.Data.DbType.String, HomeMakerSourceOfIncome);
                    database.AddInParameter(command, "HomeMakerIncomeAmount", System.Data.DbType.String, HomeMakerIncomeAmount);
                    ...
                    database.AddInParameter(command, "VehicleCost", System.Data.DbType.String, VehicleCost);
                    ...
                    database.AddInParameter(command, "ArticleCost", System.Data.DbType.String, ArticleCost);

                    database.AddInParameter(command, "IsEligible", System.Data.DbType.String, IsEligible);
