...
{
    public class CommonMetaMasterModel : CommonProperties
    {
        ...
        public void Select_MasterMeta()
        {
            ...
            spName = "dbo.CommonMasterMaintainenceSelect_new";
        ...
        public void GetAuxData()
        {
            sqlParams = new SqlParameter[]{
                        ...
                        new SqlParameter("@_userLoginId", _userLoginId),
            };

            spName = "dbo.CommonMasterMaintainenceAuxSelect_new";
            // spName = "[dbo].[CommonGapData_MasterAuxSelect]";
            ExecuteSelectDataSet();
        }

        public int CommonMasterMaintainenceInsertUpdate(CommonMetaMasterModel _obj)
        {
            Database database = factory.Create("ConnStringDecr");

            ///////////////////////////////////////// CODE FOR SQL //////////////////////////////////////////////////

            DbCommand command = database.GetStoredProcCommand("dbo.CommonMasterMaintainenceInsertUpdate_new");
        ...
        public void GetEventTemplate()
        {
            ...
            spName = "dbo.CommonMasterMaintainenceTemplateSelect_new";
            //  spName = "[dbo].[CommonGapData_MasterSelect]";
            ExecuteSelectDataSet();
        }
    }
