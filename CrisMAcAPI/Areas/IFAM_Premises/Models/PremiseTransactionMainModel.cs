...
{
    public class PremiseTransactionMainModel : CommonProperties
    {
        ...
        public DataSet PremiseTransactionMainParameterised()
        {
        ...
        public DataSet PremiseTransactionMainSelect()
        {
        ...
        public DataSet PremiseTransactionEnquirySelect()
        {
            Database database = factory.Create("ConnStringDecr");
            DbCommand command = database.GetStoredProcCommand("PrmsAssetDetailSelectTxnInqry");  //To fetch grid data
            DataSet ds = new DataSet();
            try
            {
                using (command)
