...
namespace CrisMAcAPI.Areas.UPGRADATION.Models
{
    public class AxisUpgradationModel : CommonProperties
    {
        ...
        public DataSet TldlRepaySchSelect()
        {
            ...
            DbCommand command = database.GetStoredProcCommand("UPGRD.TLDL_RepaySchSelect_View");
        ...
        public DataSet BillDetailSelect()          //----------------------- BillDetailSelect
        {
            ...
            Database database = factory.Create("ConnStringDecr");
            DbCommand command = database.GetStoredProcCommand("UPGRD.BillDetailSelect_View");
            DataSet ds = new DataSet();
            try
            {
                using (command)
        ...
        public DataSet CcodDetailSelect()
        {
            ...
            Database database = factory.Create("ConnStringDecr");
            DbCommand command = database.GetStoredProcCommand("UPGRD.CCOD_DetailSelect_View");
            DataSet ds = new DataSet();
            try
            {
                using (command)
        ...
        public DataSet UpgradationParameterSelect()
        {
            ...
            Database database = factory.Create("ConnStringDecr");
            DbCommand command = database.GetStoredProcCommand("UPGRD.UpgradationParameterSelect");
            DataSet ds = new DataSet();
            try
            {
                using (command)
        ...
        public DataSet MarkUpgradationcycleSelect()
        {
            ...
            Database database = factory.Create("ConnStringDecr");
            DbCommand command = database.GetStoredProcCommand("UPGRD.MarkUpgradationCycleSelect");
            DataSet ds = new DataSet();
            try
            {
                using (command)
        ...
        public DataSet UpgradeAuth_Select()          
        {
            ...
            Database database = factory.Create("ConnStringDecr");
            DbCommand command = database.GetStoredProcCommand("UPGRD.UpgradeApprovalAuthrSelect");
            DataSet ds = new DataSet();
            try
            {
                using (command)
