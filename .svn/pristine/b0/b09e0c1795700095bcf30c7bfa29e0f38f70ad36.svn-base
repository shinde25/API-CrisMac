   ...
   public class CommonNewCreateAssetModel : CommonProperties
    {
       ...
       // public string TxnSysTotalDeprId { get; set; }
        ...
        public DataSet FetchInitiFreezSelect()
        {
            Database database = factory.Create("ConnStringDecr");
            DbCommand command = database.GetStoredProcCommand("QTR_InitialisedSelect");
            DataSet ds = new DataSet();
            try
            {
                using (command)
        ...
        public object InsertUpdateIntiFreezingModel()
        {
            Database database = factory.Create("ConnStringDecr");
            DbCommand command = database.GetStoredProcCommand("QTR_InitialisedFrozenReset");
            try
            {
                using (command)
                {
